        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Produtos Variados</h3>
              <p className="text-gray-600 dark:text-gray-400">Grande variedade de produtos em eletrônicos, roupas, joias e muito mais.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Compra Segura</h3>
              <p className="text-gray-600 dark:text-gray-400">Suas informações protegidas com a mais alta tecnologia de segurança.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">Receba seus produtos rapidamente com nosso sistema de entrega otimizado.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          {data.length === 0 ? (
            <div className="flex justify-center items-center py-20">
              <div className="text-center">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-400">Carregando produtos...</p>
              </div>
            </div>
          ) : (
